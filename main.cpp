...
enum optionIndex
{
    ...
    _MAX_BARCODE_SPANNING_LENGTH, _WINDOW_OVERLAP, STATS, _NEWFORMAT, USESECONDARY, _KEEP_PHASING_INFO, _BASEOFFSET, _HYBRID,PROTOCOLS,_NO_CHECK_SORE, CONFIDENCE_FILE, WEIGHTS
};
